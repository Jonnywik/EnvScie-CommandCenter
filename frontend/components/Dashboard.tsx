...
export default function Dashboard() {
  ...
  if (tab === "Incident Triage") return <IncidentTriageView incidents={incidents} alerts={alerts} appearance={appearance} onAppearanceChange={toggleAppearance} onAction={onAction} onRefresh={load} onReturn={() => setTab("Overview")} />;
  if (tab === "Fleet & Responder Safety") return <FleetResponderSafetyView groups={responseGroups} gis={gis} appearance={appearance} onAppearanceChange={toggleAppearance} onAction={onAction} onRefresh={load} onReturn={() => setTab("Overview")} />;
  if (tab === "DRRMO Intelligence") return <IntelligenceDashboardView health={feedHealth} connection={connection} summary={summary} appearance={appearance} onAppearanceChange={toggleAppearance} onAction={onAction} onReturn={() => setTab("Overview")} />;
