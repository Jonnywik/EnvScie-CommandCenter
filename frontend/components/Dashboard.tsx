...
export default function Dashboard() {
  ...
  if (tab === "Incident Triage") return <IncidentTriageView incidents={incidents} alerts={alerts} appearance={appearance} onAppearanceChange={toggleAppearance} onAction={onAction} onRefresh={load} onReturn={() => setTab("Overview")} onNavigate={setTab} selectedIncidentId={selected?.id} />;
