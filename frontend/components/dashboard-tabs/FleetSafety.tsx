...
export function FleetResponderSafetyView({ groups, gis, appearance, onAppearanceChange, onAction, onRefresh, onReturn }: { groups: ResponseGroupSnapshot; gis: GisMapSnapshot; appearance: AppearanceMode; onAppearanceChange: () => void; onAction: OperationalAction; onRefresh: () => Promise<void>; onReturn: () => void }) {
