...
export function FleetResponderSafetyView({ groups, gis, onAction, onRefresh, onReturn }: { groups: ResponseGroupSnapshot; gis: GisMapSnapshot; onAction: OperationalAction; onRefresh: () => Promise<void>; onReturn: () => void }) {
