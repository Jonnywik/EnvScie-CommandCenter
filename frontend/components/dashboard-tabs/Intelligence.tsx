...
export function IntelligenceDashboardView({ health, connection, summary, onAction, onReturn }: { health: FeedHealth[]; connection: "live" | "cached"; summary: DashboardSummary; onAction: OperationalAction; onReturn: () => void }) {
